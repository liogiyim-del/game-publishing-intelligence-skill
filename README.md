...
> **不是帮你搜更多新闻，而是帮你判断这条信息对发行到底意味着什么。**
...
flowchart TB
  subgraph A[Research]
    A1[Discovery] --> A2[Normalize & Dedup]
    A2 --> A3[Evidence Enrichment]
    A3 --> A4[Value Routing]
  end

  subgraph B[Decision]
    B1[Module Analysis] --> B2[Business Analysis]
    B2 --> B3[Calendar Update]
    B3 --> B4[Final QA]
  end
...
同一事件中的官方公告、商店变化、媒体报道、玩家讨论、公开数据和后续回应，会尽量聚合到同一条事件链。
...
### 03 — Business reasoning, not summary
...
<details>
<summary><strong>展开：Product Coordinates & Full Release Path</strong></summary>
...
![Case Mechanism](assets/case-mechanism-compact.png)
